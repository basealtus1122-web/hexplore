...
const SHARED = {
  ...
  classes: {
    ...
    cursedOne: {
      ...
      stats:{
        ...
        secondMastery:{base:1, name:{en:"Speciality",ko:"특기"}, cost:1,
          readout:(E)=>[
            {lab:"Cost 비용", color:"energy", val:1},
            {lab:"Skill 스킬 보너스", color:"neutral", val:"-1"},
            {lab:"Boost 전투 증폭", color:"attack", val:E.lv("secondMastery").toFixed(1)},
          ],
          desc:`<b>비전투:</b> 해당 페이즈(Movement·Skill 등)가 끝날 때까지 모든 영웅이 스킬 판정에 <b>-1</b> 보너스를 받는다. 특정 스킬의 랭크 <b>5마다</b> 그 스킬에 <b>-1</b> 보너스가 추가된다. <b>전투:</b> 또다른 자아로 변신한 뒤 사용하면, 그 Encounter조우의 행동 중 하나를 수행하고 그 피해를 {secondMastery} 랭크만큼 <kw>boost</kw>한다. <lvl n="8">{secondMastery}로 피해를 입은 대상은 다음 라운드에 목표를 <b>1</b> 적게 잡는다(최소 1).</lvl>`,
        },
        navigate:{base:2, name:{en:"Navigate",ko:"길찾기"}},
        explore:{base:2, name:{en:"Explore",ko:"탐험"}},
        survival:{base:1, name:{en:"Survival",ko:"생존"}},
    ...
    shadowRider: {
      ...
      special:{ko:`각 기술이 <b>처음으로 8랭크</b>가 될 때마다, 그룹의 <b>Movement Speed이동 속도</b>가 <b>1</b> 증가한다(<b>Moving Cautiously신중한 이동</b> 포함).`},
      stats:{
    ...
    enchanter: {
      ...
      special:{ko:`게임 시작 전, 파워업을 <b>3</b>장 뽑아 자신의 <b>Essence정수</b>로 획득한다. {secondMastery} 랭크 <b>4마다</b> 턴당 <b>1회</b>, 파워업 버린 더미의 맨 위 카드를 가져와 정수에 추가할 수 있다. 정수를 버릴 때는 파워업 버린 더미의 <b>맨 아래</b>에 놓는다.`},
      stats:{
    ...
    witch: {
      ...
      special:{ko:`게임 시작 시 원하는 <b>Familiar사역마</b> 하나를 골라 가지고 시작한다. {defence} 랭크 대신 자신의 Familiar사역마 능력 랭크를 사용할 수 있다.`},
      stats:{
        ...
        firstMastery:{base:2, name:{en:"Hex",ko:"주술"}, cost:1,
          ...
          desc:`적을 약화시키고 자신과 동료에게 힘을 준다. {attack} 랭크 + {firstMastery} 랭크만큼 <st>energy</st> 피해를 주고, {firstMastery} 랭크의 <b>절반</b>만큼 <st>energy</st>를 원하는 영웅들에게 나눠 <kw>raise</kw>한다. <lvl n="4">전투 중이 아닐 때 {firstMastery}를 사용해, 플레이 중이거나 버린 더미에 있는 <b>Affliction고통</b> 카드 1장을 가져와 획득한다. {firstMastery}는 자신이 가진 <b>Affliction고통</b> 1장마다 <st>energy</st> 피해 <b>6</b>을 추가로 준다.</lvl> <lvl n="7">이 라운드에 {attack}도 함께 사용할 수 있다.</lvl>`,
        },
        secondMastery:{base:2, name:{en:"Coven",ko:"마녀 집회"}, cost:1,
          ...
          desc:`동료는 각자 {defence} 랭크까지 <st>energy</st>를 소모할 수 있다. 적 공격의 피해를 {secondMastery} 랭크의 <b>절반</b> + <st>energy</st>를 소모한 동료 <b>1명당 1</b>만큼 감소시킨다. <lvl n="6">적의 <st>energy</st>가 0이면, 자신이 가진 <b>Affliction고통</b> 1장마다 <kw>piercing</kw> <st>health</st> 피해 <b>3</b>도 준다.</lvl>`,
        },
        navigate:{base:2, name:{en:"Navigate",ko:"길찾기"}},
        explore:{base:1, name:{en:"Explore",ko:"탐험"}},
        survival:{base:2, name:{en:"Survival",ko:"생존"}},
