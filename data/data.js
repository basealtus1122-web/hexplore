...
const SHARED = {
  ...
  races: {
    ...
    archon:{ id:"archon", ed:"5", exp:"H", name:{en:"Archon",ko:"아르콘"},
    ...
    ettin:{ id:"ettin", ed:"5", exp:"H", name:{en:"Ettin",ko:"에틴"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    incubus:{ id:"incubus", ed:"5", exp:"H", name:{en:"Incubus",ko:"인큐버스"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    legion:{ id:"legion", ed:"5", exp:"H", name:{en:"Legion",ko:"리전"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    leprechaun:{ id:"leprechaun", ed:"5", exp:"H", name:{en:"Leprechaun",ko:"레프러콘"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    minotaur:{ id:"minotaur", ed:"5", exp:"H", name:{en:"Minotaur",ko:"미노타우로스"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    redcap:{ id:"redcap", ed:"5", exp:"H", name:{en:"Redcap",ko:"레드캡"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    solarElf:{ id:"solarElf", ed:"5", exp:"H", name:{en:"Solar Elf",ko:"솔라 엘프"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    succubus:{ id:"succubus", ed:"5", exp:"H", name:{en:"Succubus",ko:"서큐버스"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    rubyGolem:{ id:"rubyGolem", ed:"5", exp:"R", name:{en:"Ruby Golem",ko:"루비 골렘"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    youngRedDragon:{ id:"youngRedDragon", ed:"5", exp:"R", name:{en:"Young Red Dragon",ko:"어린 레드 드래곤"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    youngSilverDragon:{ id:"youngSilverDragon", ed:"5", exp:"R", name:{en:"Young Silver Dragon",ko:"어린 실버 드래곤"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    // --- Return to Caprakan ---
    ...
    saurian:{ id:"saurian", ed:"5", exp:"H", name:{en:"Saurian",ko:"사우리안"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
    voidTouched:{ id:"voidTouched", ed:"5", exp:"H", name:{en:"Void Touched",ko:"보이드 터치드"},
      favoredEnemy:{en:"—",ko:"미정"}, foodUse:1, mods:{health:0,energy:0,attack:0,defence:0,firstMastery:0,secondMastery:0,navigate:0,explore:0,survival:0},
      ability:{name:{en:"Racial Ability",ko:"종족 능력"}, desc:"(내용 추후 입력)", track:{type:"check"}}, flavor:"" },
