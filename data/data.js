...
const KW_COMMON = {
  ...
  defend:{name:{en:"Defend X",ko:"방어"}, desc:`Resolution 페이즈에 받는 각 피해 효과를 X만큼 감소시킵니다.`},
...
const CONDITIONS = {
  ...
  entangled:{name:{en:"Entangled",ko:"얽힘"}, q:["S"], desc:`얽힌 영웅은 정상적으로 행동하려면 매 라운드 Declaration 페이즈에 <st>navigate</st> 굴림에 성공해야 한다. 실패하면 공격이나 <st>defence</st>만 -3 페널티를 받고 할 수 있다.`},
